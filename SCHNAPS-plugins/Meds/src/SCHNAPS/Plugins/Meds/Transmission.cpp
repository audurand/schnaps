...
Transmission& Transmission::operator=(const Transmission& inOriginal) {
	...
	return *this;
	schnaps_StackTraceEndM("SCHNAPS::Plugins::Meds::Transmission& SCHNAPS::Plugins::Meds::Transmission::operator=(const SCHNAPS::Plugins::Meds::Transmission&)");
}
...
void Transmission::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Meds::Transmission::writeContent(PACC::XML::Streamer&, bool) const");
}
...
const std::string& Transmission::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	return lType;
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Meds::Transmission::getReturnType(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
