...
UpdateQaly::UpdateQaly(const UpdateQaly& inOriginal) :
 ...
 */
UpdateQaly& UpdateQaly::operator=(const UpdateQaly& inOriginal) {
	...
	return *this;
	schnaps_StackTraceEndM("SCHNAPS::Plugins::Meds::UpdateQaly& SCHNAPS::Plugins::Meds::UpdateQaly::operator=(const SCHNAPS::Plugins::Meds::UpdateQaly&)");
}
 ...
 */
void UpdateQaly::readWithSystem(PACC::XML::ConstIterator inIter, Core::System& ioSystem) {
	schnaps_StackTraceBeginM();
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Meds::UpdateQaly::readWithSystem(PACC::XML::ConstIterator, SCHNAPS::Core::System&)");
}
 ...
 */
void UpdateQaly::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	schnaps_StackTraceBeginM();
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Meds::UpdateQaly::writeContent(PACC::XML::Streamer&, bool) const");
}
 ...
 */
Core::AnyType::Handle UpdateQaly::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	...
	double lQaly, lDiscountRate, lTotalQaly;
	...
	lContext.getIndividual().getState().setVariable(mOldQaly_Ref.substr(1), new Core::Double(lTotalQaly));
	lContext.getIndividual().getState().setVariable(mOutQaly_Ref.substr(1), new Core::Double(lTotalQaly+lQaly/std::pow(lDiscountRate + 1, lTime)));
	
	
	return NULL;
	schnaps_StackTraceEndM("SCHNAPS::Core::AnyType::Handle SCHNAPS::Plugins::Meds::UpdateQaly::execute(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
 ...
 */
const std::string& UpdateQaly::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	const static std::string lType("Void");
	return lType;
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Meds::UpdateQaly::getReturnType(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
