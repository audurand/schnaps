...
void Test::readWithSystem(PACC::XML::ConstIterator inIter, Core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Meds::Test::readWithSystem(PACC::XML::ConstIterator, Core::System&)");
}
...
Core::AnyType::Handle Test::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return NULL;
	schnaps_StackTraceEndM("Core::AnyType::Handle SCHNAPS::Plugins::Meds::Test::execute(unsigned int, Core::ExecutionContext&) const");
}
...
const std::string& Test::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Meds::Test::getReturnType(unsigned int, Core::ExecutionContext&) const");
}
