...
#ifndef SCHNAPS_Plugins_Contacts_Transmission_hpp
#define SCHNAPS_Plugins_Contacts_Transmission_hpp
...
/*!
 *  \class Transmission SCHNAPS/Plugins/Contacts/Transmission.hpp "SCHNAPS/Plugins/Contacts/Transmission.hpp"
...
public:
	...
	virtual const std::string& getName() const {
		...
		const static std::string lName("Contacts_Transmission");
		return lName;
		schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Contacts::Transmission::getName() const");
	}
...
#endif /* SCHNAPS_Plugins_Contacts_Transmission_hpp */
