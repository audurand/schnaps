 ...
 */
SubVariable& SubVariable::operator=(const SubVariable& inOriginal) {
	...
	return *this;
	schnaps_StackTraceEndM("SCHNAPS::Plugins::Operators::SubVariable& SCHNAPS::Plugins::Operators::SubVariable::operator=(const SCHNAPS::Plugins::Operators::SubVariable&)");
}
