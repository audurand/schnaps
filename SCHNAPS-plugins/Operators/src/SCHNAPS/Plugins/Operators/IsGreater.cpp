...
/*!
 * \brief Construct a comparison operator (is greater) between left and right argument as a copy of an original.
 * \param inOriginal A const reference to the original comparison operator (is greater) between left and right argument.
 */
 ...
 */
void IsGreater::readWithSystem(PACC::XML::ConstIterator inIter, Core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Operators::IsGreater::readWithSystem(PACC::XML::ConstIterator, SCHNAPS::Core::System&)");
}
 ...
 */
void IsGreater::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	schnaps_StackTraceBeginM();
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Operators::IsGreater::writeContent(PACC::XML::Streamer&, bool) const");
}
