...
Mult& Mult::operator=(const Mult& inOriginal) {
	...
	return *this;
	schnaps_StackTraceEndM("SCHNAPS::Plugins::Operators::Mult& SCHNAPS::Plugins::Operators::Mult::operator=(const SCHNAPS::Plugins::Operators::Mult&)");
}
...
Core::AnyType::Handle Mult::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	lArg1->mult(*lArg2);
	return lArg1;
	schnaps_StackTraceEndM("SCHNAPS::Core::AnyType::Handle SCHNAPS::Plugins::Operators::Mult::execute( unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
...
const std::string& Mult::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Mult::getArgType(unsigned int, unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
...
const std::string& Mult::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Mult::getReturnType(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
