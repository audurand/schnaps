...
Mult& Mult::operator=(const Mult& inOriginal) {
	schnaps_StackTraceBeginM();
		return *this;
	schnaps_StackTraceEndM("Core::Mult& SCHNAPS::Plugins::Operators::Mult::operator=(const Core::Mult&)");
}
...
Core::AnyType::Handle Mult::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		lArg1->mult(*lArg2);
		return lArg1;
	schnaps_StackTraceEndM("Core::AnyType::Handle SCHNAPS::Plugins::Operators::Mult::execute( unsigned int, Core::ExecutionContext&) const");
}
...
const std::string& Mult::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Mult::getArgType(unsigned int, unsigned int, Core::ExecutionContext&) const");
}
...
const std::string& Mult::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Mult::getReturnType(unsigned int, Core::ExecutionContext&) const");
}
