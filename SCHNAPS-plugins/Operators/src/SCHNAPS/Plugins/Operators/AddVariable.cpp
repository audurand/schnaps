...
void AddVariable::readWithSystem(PACC::XML::ConstIterator inIter, Core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Operators::AddVariable::readWithSystem(PACC::XML::ConstIterator, Core::System&)");
}
...
Core::AnyType::Handle AddVariable::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return NULL;
	schnaps_StackTraceEndM("Core::AnyType::Handle SCHNAPS::Plugins::Operators::AddVariable::execute(unsigned int, Core::ExecutionContext&)");
}
...
const std::string& AddVariable::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::AddVariable::getReturnType(unsigned int, Core::ExecutionContext&) const");
}
