 ...
 */
AddComplex::AddComplex(const AddComplex& inOriginal) :
	Primitive(2)
{}
 ...
 */
Core::AnyType::Handle AddComplex::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	...
	return lArg1->add(*lArg2);
	schnaps_StackTraceEndM("SCHNAPS::Core::AnyType::Handle SCHNAPS::Plugins::Operators::AddComplex::execute(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
 ...
 */
const std::string& AddComplex::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::AddComplex::getArgType(unsigned int, unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
 ...
 */
const std::string& AddComplex::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	unsigned int lNodeIndex = getArgumentIndex(inIndex, 0, ioContext);
	return ioContext.getPrimitiveTree()[lNodeIndex].mPrimitive->getReturnType(inIndex, ioContext);
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::AddComplex::getReturnType(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
