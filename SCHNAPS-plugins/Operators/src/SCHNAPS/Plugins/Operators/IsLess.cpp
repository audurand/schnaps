...
Core::AnyType::Handle IsLess::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("SCHNAPS::Core::AnyType::Handle SCHNAPS::Plugins::Operators::IsLess::execute(unsigned int, SCHNAPS::Core::ExecutionContext&)");
}
...
const std::string& IsLess::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::IsLess::getArgType(unsigned int, unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
