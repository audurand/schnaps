 ...
 */
Core::AnyType::Handle DivComplex::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	...
	return lArg1->div(*lArg2);;
	schnaps_StackTraceEndM("SCHNAPS::Core::AnyType::Handle SCHNAPS::Plugins::Operators::DivComplex::execute(unsigned int, SCHNAPS::Core::ExecutionContext&)");
}
 ...
 */
const std::string& DivComplex::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::DivComplex::getArgType(unsigned int, unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
 ...
 */
const std::string& DivComplex::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
	unsigned int lNodeIndex = getArgumentIndex(inIndex, 0, ioContext);
	return ioContext.getPrimitiveTree()[lNodeIndex].mPrimitive->getReturnType(inIndex, ioContext);
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::DivComplex::getReturnType(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
