...
Exp& Exp::operator=(const Exp& inOriginal) {
	schnaps_StackTraceBeginM();
		return *this;
	schnaps_StackTraceEndM("Core::Exp& SCHNAPS::Plugins::Operators::Exp::operator=(const Core::Exp&)");
}
...
Core::AnyType::Handle Exp::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		lArg1->exp();
		return lArg1;
	schnaps_StackTraceEndM("Core::AnyType::Handle SCHNAPS::Plugins::Operators::Exp::execute(unsigned int, Core::ExecutionContext&) const");
}
...
const std::string& Exp::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	...
	schnaps_AssertM(inN<1);
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Exp::getArgType(unsigned int , unsigned int, Core::ExecutionContext&) const");
}
...
const std::string& Exp::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Exp::getReturnType(unsigned int, Core::ExecutionContext&) const");
}
