...
Pow& Pow::operator=(const Pow& inOriginal) {
	...
	return *this;
	schnaps_StackTraceEndM("SCHNAPS::Plugins::Operators::Pow& SCHNAPS::Plugins::Operators::Pow::operator=(const SCHNAPS::Plugins::Operators::Pow&)");
}
...
Core::AnyType::Handle Pow::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	lArg1->pow(*lArg2);
	return lArg1;
	schnaps_StackTraceEndM("SCHNAPS::Core::AnyType::Handle SCHNAPS::Plugins::Operators::Pow::execute(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
...
const std::string& Pow::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Pow::getArgType(unsigned int , unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
...
const std::string& Pow::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	unsigned int lNodeIndex = getArgumentIndex(inIndex, 0, ioContext);
	return ioContext.getPrimitiveTree()[lNodeIndex].mPrimitive->getReturnType(inIndex, ioContext);
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Pow::getReturnType(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
