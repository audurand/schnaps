 ...
 */
void IsLessOrEqual::readWithSystem(PACC::XML::ConstIterator inIter, Core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Operators::IsLessOrEqual::readWithSystem(PACC::XML::ConstIterator, SCHNAPS::Core::System&)");
}
 ...
 */
void IsLessOrEqual::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	schnaps_StackTraceBeginM();
	...
	schnaps_StackTraceEndM("void SCHNAPS::Plugins::Operators::IsLessOrEqual::writeContent(PACC::XML::Streamer&, bool) const");
}
...
Core::AnyType::Handle IsLessOrEqual::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	return new Core::Bool(lArgLeft->isLess(*lArgRight) || lArgLeft->isEqual(*lArgRight));
