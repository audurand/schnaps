...
Div& Div::operator=(const Div& inOriginal) {
	...
	return *this;
	schnaps_StackTraceEndM("SCHNAPS::Plugins::Operators::Div& SCHNAPS::Plugins::Operators::Div::operator=(const SCHNAPS::Plugins::Operators::Div&)");
}
...
Core::AnyType::Handle Div::execute(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	lArg1->div(*lArg2);
	return lArg1;
	schnaps_StackTraceEndM("SCHNAPS::Core::AnyType::Handle SCHNAPS::Plugins::Operators::Div::execute(unsigned int, SCHNAPS::Core::ExecutionContext&)");
}
...
const std::string& Div::getArgType(unsigned int inIndex, unsigned int inN, Core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Div::getArgType(unsigned int, unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
...
const std::string& Div::getReturnType(unsigned int inIndex, Core::ExecutionContext& ioContext) const {
	...
	unsigned int lNodeIndex = getArgumentIndex(inIndex, 0, ioContext);
	return ioContext.getPrimitiveTree()[lNodeIndex].mPrimitive->getReturnType(inIndex, ioContext);
	schnaps_StackTraceEndM("const std::string& SCHNAPS::Plugins::Operators::Div::getReturnType(unsigned int, SCHNAPS::Core::ExecutionContext&) const");
}
