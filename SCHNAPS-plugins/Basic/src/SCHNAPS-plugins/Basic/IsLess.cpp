...
IsLess& IsLess::operator=(const IsLess& inOriginal) {
	schnaps_StackTraceBeginM();
		return *this;
	schnaps_StackTraceEndM("core::IsLess& core::IsLess::operator=(const core::IsLess&)");
}
...
core::AnyType::Handle IsLess::execute(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("core::AnyType::Handle core::IsLess::execute(unsigned int, core::ExecutionContext&)");
}
...
const std::string& IsLess::getArgType(unsigned int inIndex, unsigned int inN, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& core::IsLess::getArgType(unsigned int, unsigned int, core::ExecutionContext&) const");
}
...
const std::string& IsLess::getReturnType(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& core::IsLess::getReturnType(unsigned int, core::ExecutionContext&) const");
}
