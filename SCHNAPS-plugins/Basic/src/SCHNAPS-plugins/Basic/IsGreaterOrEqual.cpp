...
IsGreaterOrEqual& IsGreaterOrEqual::operator=(const IsGreaterOrEqual& inOriginal) {
	schnaps_StackTraceBeginM();
		return *this;
	schnaps_StackTraceEndM("core::IsGreaterOrEqual& core::IsGreaterOrEqual::operator=(const core::IsGreaterOrEqual&)");
}
...
core::AnyType::Handle IsGreaterOrEqual::execute(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("core::AnyType::Handle core::IsGreaterOrEqual::execute(unsigned int, core::ExecutionContext&)");
}
...
const std::string& IsGreaterOrEqual::getArgType(unsigned int inIndex, unsigned int inN, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& core::IsGreaterOrEqual::getArgType(unsigned int, unsigned int, core::ExecutionContext&) const");
}
...
const std::string& IsGreaterOrEqual::getReturnType(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& core::IsGreaterOrEqual::getReturnType(unsigned int, core::ExecutionContext&) const");
}
