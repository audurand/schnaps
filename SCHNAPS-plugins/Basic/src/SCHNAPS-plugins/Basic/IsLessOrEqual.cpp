...
IsLessOrEqual& IsLessOrEqual::operator=(const IsLessOrEqual& inOriginal) {
	schnaps_StackTraceBeginM();
		return *this;
	schnaps_StackTraceEndM("core::IsLessOrEqual& core::IsLessOrEqual::operator=(const core::IsLessOrEqual&)");
}
...
core::AnyType::Handle IsLessOrEqual::execute(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("core::AnyType::Handle core::IsLessOrEqual::execute(unsigned int, core::ExecutionContext&)");
}
...
const std::string& IsLessOrEqual::getArgType(unsigned int inIndex, unsigned int inN, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("const std::string& core::IsLessOrEqual::getArgType(unsigned int, unsigned int, core::ExecutionContext&) const");
}
...
const std::string& IsLessOrEqual::getReturnType(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& core::IsLessOrEqual::getReturnType(unsigned int, core::ExecutionContext&) const");
}
