...
void AddVariable::readWithSystem(PACC::XML::ConstIterator inIter, core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void simulator::AddVariable::readWithSystem(PACC::XML::ConstIterator, core::System&)");
}
...
void AddVariable::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	...
	schnaps_StackTraceEndM("void simulator::AddVariable::writeContent(PACC::XML::Streamer&, bool) const");
}
...
core::AnyType::Handle AddVariable::execute(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		lVariable->add(*lTempValue);
		return NULL;
	schnaps_StackTraceEndM("core::AnyType::Handle simulator::AddVariable::execute(unsigned int, core::ExecutionContext&)");
}
...
const std::string& AddVariable::getReturnType(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& simulator::AddVariable::getReturnType(unsigned int, core::ExecutionContext&) const");
}
