...
void IsEqualVariable::readWithSystem(PACC::XML::ConstIterator inIter, core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void simulator::IsEqualVariable::readWithSystem(PACC::XML::ConstIterator, core::System&)");
}
...
void IsEqualVariable::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	...
	schnaps_StackTraceEndM("void simulator::IsEqualVariable::writeContent(PACC::XML::Streamer&, bool) const");
}
...
core::AnyType::Handle IsEqualVariable::execute(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("core::AnyType::Handle simulator::IsEqualVariable::execute(unsigned int, core::ExecutionContext&)");
}
...
const std::string& IsEqualVariable::getReturnType(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& simulator::IsEqualVariable::getReturnType(unsigned int, core::ExecutionContext&) const");
}
