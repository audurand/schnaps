...
void MultVariable::readWithSystem(PACC::XML::ConstIterator inIter, core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void simulator::MultVariable::readWithSystem(PACC::XML::ConstIterator, core::System&)");
}
...
void MultVariable::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	...
	schnaps_StackTraceEndM("void simulator::MultVariable::writeContent(PACC::XML::Streamer&, bool) const");
}
...
core::AnyType::Handle MultVariable::execute(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return NULL;
	schnaps_StackTraceEndM("core::AnyType::Handle simulator::MultVariable::execute(unsigned int, core::ExecutionContext&)");
}
...
const std::string& MultVariable::getReturnType(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& simulator::MultVariable::getReturnType(unsigned int, core::ExecutionContext&) const");
}
