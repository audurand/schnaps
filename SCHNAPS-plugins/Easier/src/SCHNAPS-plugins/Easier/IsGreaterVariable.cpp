...
void IsGreaterVariable::readWithSystem(PACC::XML::ConstIterator inIter, core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void simulator::IsGreaterVariable::readWithSystem(PACC::XML::ConstIterator, core::System&)");
}
...
void IsGreaterVariable::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	...
	schnaps_StackTraceEndM("void simulator::IsGreaterVariable::writeContent(PACC::XML::Streamer&, bool) const");
}
...
core::AnyType::Handle IsGreaterVariable::execute(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	...
	schnaps_StackTraceEndM("core::AnyType::Handle simulator::IsGreaterVariable::execute(unsigned int, core::ExecutionContext&)");
}
...
const std::string& IsGreaterVariable::getReturnType(unsigned int inIndex, core::ExecutionContext& ioContext) const {
	schnaps_StackTraceBeginM();
		...
		return lType;
	schnaps_StackTraceEndM("const std::string& simulator::IsGreaterVariable::getReturnType(unsigned int, core::ExecutionContext&) const");
}
