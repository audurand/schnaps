 ...
 */
class SimulationThread: public SCHNAPS::Core::Object, public PACC::Threading::Thread {
public:
	//! SimulationThread allocator type.
	typedef SCHNAPS::Core::AllocatorT<SimulationThread, SCHNAPS::Core::Object::Alloc> Alloc;
	//! SimulationThread handle type.
	typedef SCHNAPS::Core::PointerT<SimulationThread, SCHNAPS::Core::Object::Handle> Handle;
	//! SimulationThread bag type.
	typedef SCHNAPS::Core::ContainerT<SimulationThread, SCHNAPS::Core::Object::Bag> Bag;
	...
	void addNewIndexes(unsigned int inLowerBound, unsigned int inUpperBound) {
		...
		unsigned int lNbThreads = SCHNAPS::Core::castHandleT<SCHNAPS::Core::UInt>(mContext->getSystem().getParameters()["threads.simulator"])->getValue();
