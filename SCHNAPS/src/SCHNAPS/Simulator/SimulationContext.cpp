...
//				mProcesses[lChild->getAttribute("label")]->validate(*this);
	...
	schnaps_StackTraceEndM("void simulator::SimulationContext::readProcesses(PACC::XML::ConstIterator)");
}
...
void SimulationContext::readObservers(PACC::XML::ConstIterator inIter) {
	...
	schnaps_StackTraceEndM("void simulator::SimulationContext::readObservers(PACC::XML::ConstIterator)");
}
...
void SimulationContext::readScenarios(PACC::XML::ConstIterator inIter) {
	...
	schnaps_StackTraceEndM("void simulator::SimulationContext::readScenarios(PACC::XML::ConstIterator)");
}
...
void SimulationContext::writeProcesses(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	schnaps_StackTraceBeginM();
		...
		ioStreamer.closeTag();
	schnaps_StackTraceEndM("void simulator::SimulationContext::writeProcesses(PACC::XML::Streamer&, bool) const");
}
...
void SimulationContext::writeObservers(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	schnaps_StackTraceBeginM();
		...
		ioStreamer.closeTag();
	schnaps_StackTraceEndM("void simulator::SimulationContext::writeObservers(PACC::XML::Streamer&, bool) const");
}
...
void SimulationContext::writeScenarios(PACC::XML::Streamer& ioStreamer, bool inIndent) const {
	schnaps_StackTraceBeginM();
		...
		ioStreamer.closeTag();
	schnaps_StackTraceEndM("void simulator::SimulationContext::writeScenarios(PACC::XML::Streamer&, bool) const");
}
...
SimulationContext::Handle SimulationContext::deepCopy() const {
	...
	schnaps_StackTraceEndM("simulator::SimulationContext::Handle simulator::SimulationContext::deepCopy() const");
}
