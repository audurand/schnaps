...
#ifndef simulator_Process_hpp
#define simulator_Process_hpp
...
/*!
 *  \class Process Simulator/include/Process.hpp "Simulator/include/Process.hpp"
...
public:
	...
	explicit Process(const std::string inLabel, core::PrimitiveTree::Handle inPrimitiveTree);
	virtual ~Process() {}
	...
	Process::Handle deepCopy(const core::System& ioSystem) const;
...
private:
	core::PrimitiveTree::Handle mPrimitiveTree;
};
} // end of simulator namespace

#endif /* simulator_Process_hpp */
