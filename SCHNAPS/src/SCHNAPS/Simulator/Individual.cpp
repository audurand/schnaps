...
void Individual::readWithSystem(PACC::XML::ConstIterator inIter, core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void simulator::Individual::readWithSystem(PACC::XML::ConstIterator, core::System&)");
}
