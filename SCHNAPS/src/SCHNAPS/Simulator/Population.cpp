 ...
 */
void Population::readWithSystem(PACC::XML::ConstIterator inIter, core::System& ioSystem) {
	...
	schnaps_StackTraceEndM("void simulator::Population::readWithSystem(PACC::XML::ConstIterator, core::System&)");
}
 ...
 */
void Population::readFromIndexWithSystem(PACC::XML::ConstIterator inIter, core::System& ioSystem) {
	schnaps_StackTraceBeginM();
		if (inIter->getType() != PACC::XML::eData) {
			throw schnaps_IOExceptionNodeM(*inIter, "tag expected!");
		}
	...
	schnaps_StackTraceEndM("void simulator::Population::readFromIndexWithSystem(PACC::XML::ConstIterator, core::System&)");
}
...
void Population::writeSubPopulation(PACC::XML::Streamer& ioStreamer, unsigned int inFrom, unsigned int inTo, bool inIndent) const {
	...
	schnaps_AssertM(inTo <= size());
		...
		ioStreamer.closeTag();
	schnaps_StackTraceEndM("void simulator::Population::writeSubPopulation(PACC::XML::Streamer&, unsigned int, unsigned int, bool) const");
}
...
bool Population::addIndividuals(Individual::Bag::Handle lNewIndividuals) {
	schnaps_StackTraceBeginM();
		...
		return false;
	schnaps_StackTraceEndM("bool simulator::Population::addIndividuals(simulator::Individual::Bag::Handle lNewIndividuals)");
}
